...
function verificarPassword(usuario, password) {
  ...
  // De lo contrario, devuelve "false"
  // // Tu código:
  if (usuario ["password"] === password){    // la que esta en comillas es la password que esta dentro 
                                             //del objeto usuario y pregunta si coincide con password valor
  return true;
  }else{
  return false;
  }
...
function actualizarPassword(usuario, nuevaPassword) {
  ...
  // Devuelve el objeto
  // Tu código:
  usuario.password = nuevaPassword; // retornar el usuario objeto con la clave actualizada (nuevaPassword)
  return usuario;
}
...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  usuario.amigos.push (nuevoAmigo);  // usamos dot notation porque sabemos que usuario tiene esa propiedad.
  return usuario;
}
